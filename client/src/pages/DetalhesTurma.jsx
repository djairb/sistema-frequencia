                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm p-4 animate-fade-in">
                    <div className="bg-white rounded-xl shadow-2xl w-full max-w-lg overflow-hidden flex flex-col max-h-[90vh]">
                        ...
                        <form onSubmit={handleSalvarEdicao} className="p-6 overflow-y-auto">
                            {dadosEdicao.ativo == 0 && (
                                <div className="bg-red-50 text-red-600 p-3 rounded mb-4 text-sm border border-red-100 flex items-center gap-2">
                                    <AlertTriangle size={16} />
                                    <span><strong>Turma Encerrada.</strong> Reative-a para editar os dados.</span>
                                </div>
                            )}
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    ...
                                    <div>
                                        ...
                                        <input
                                            ...
                                            onChange={e => setDadosEdicao({ ...dadosEdicao, periodo: e.target.value })}
                                            required
                                            disabled={dadosEdicao.ativo == 0}
                                        />
                                    </div>
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <input
                                            ...
                                            onChange={e => setDadosEdicao({ ...dadosEdicao, data_inicio: e.target.value })}
                                            disabled={dadosEdicao.ativo == 0}
                                        />
                                    </div>
                                    <div>
                                        ...
                                        <input
                                            ...
                                            onChange={e => setDadosEdicao({ ...dadosEdicao, data_fim: e.target.value })}
                                            disabled={dadosEdicao.ativo == 0}
                                        />
                                    </div>
                                </div>
                                <div>
                                    ...
                                    <div className="flex flex-wrap gap-2">
                                        {['Seg', 'Ter', 'Qua', 'Qui', 'Sex', 'Sáb'].map(dia => (
                                            <label key={dia} className={`cursor-pointer px-3 py-1 rounded text-sm border ${dadosEdicao.dias_aula?.includes(dia) ? 'bg-blue-100 border-blue-500 text-blue-700 font-bold' : 'bg-gray-50 border-gray-200'} ${dadosEdicao.ativo == 0 ? 'opacity-50 cursor-not-allowed' : ''}`}>
                                                <input
                                                    type="checkbox"
                                                    className="hidden"
                                                    checked={dadosEdicao.dias_aula?.includes(dia) || false}
                                                    onChange={() => dadosEdicao.ativo == 1 && toggleDiaEdicao(dia)}
                                                    disabled={dadosEdicao.ativo == 0}
                                                />{dia}
                                            </label>
                                        ))}
