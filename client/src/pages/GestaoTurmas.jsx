    ...
    return (
        <div className="p-6 max-w-7xl mx-auto space-y-8 animate-fade-in">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <StatCard icon={GraduationCap} label="Total de Beneficiários" value={resumo.counters.alunos_matriculados} color="bg-green-500" />
                <StatCard icon={Users} label="Total de Professores" value={resumo.counters.professores_alocados} color="bg-purple-500" />
