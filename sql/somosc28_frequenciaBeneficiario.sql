...
--
-- Host: localhost:3306
-- Tempo de geração: 03/03/2026 às 10:30
...
(41, 47, 1, 1, '2026-02-26 12:56:08.573'),
...
(245, 262, 1, 1, '2026-02-26 16:09:03.002'),
...
(85, 10, 245, '2026-02-26 21:46:16', 'Ativo'),
...
(320, 18, 245, '2026-02-27 10:51:25', 'Ativo'),
...
(375, 19, 245, '2026-02-27 11:29:02', 'Ativo'),
...
(380, 20, 245, '2026-02-27 11:37:01', 'Ativo'),
...
(262, 'CLEONICE BERTULINA DA  SILVA', NULL, NULL, '1961-04-19 00:00:00.000', 'BERTULINA ANA DA SILVA', NULL, '36157252472', NULL, 'BRASIL', 'BRASIL', 2, 4, 1, 1, NULL, 1, '2026-02-26 16:09:03.001'),
...
(1, 19, 2026, 3, '/uploads/planos_trabalho/plano_6d57482a-a48f-4b4b-83e2-493038a35a8b.pdf', '/uploads/planos_trabalho/plano_011d1874-d0fc-44d4-93e3-eb7ac8c11807.pdf', 'Visto! muito bem ficou excelente!', '2026-03-02 12:19:05', '2026-03-02 22:38:23'),
(2, 19, 2026, 2, '/uploads/planos_trabalho/plano_4e557728-017c-4327-9d77-83dd4541fce6.pdf', '/uploads/planos_trabalho/plano_4e883981-c62d-4f05-81e3-fde9ca882222.pdf', 'Essa é a pergunta de \"um milhão de dólares\" no cenário tecnológico atual. A resposta curta é: dificilmente haverá uma substituição total, mas haverá uma transformação radical no que essas funções fazem no dia a ', '2026-03-02 12:20:31', '2026-03-02 22:48:14'),
(3, 19, 2026, 5, '/uploads/planos_trabalho/plano_a848f556-93fe-42f8-8838-e5c156cb3582.pdf', '/uploads/planos_trabalho/plano_528c3ab7-38a4-46db-8ba7-d6aff33c6fe1.pdf', 'Essa é a pergunta de \"um milhão de dólares\" no cenário tecnológico atual. A resposta curta é: dificilmente haverá uma substituição total, mas haverá uma transformação radical no que essas funções fazem no dia a dia. Para profissionais com o seu perfil, que navegam entre a infraestrutura e o desenvolvimento, o cenário é de evolução das ferramentas. 1. O Desenvolvedor: De \"Escritor de Código\" a \"Arquiteto', '2026-03-02 14:34:37', '2026-03-02 22:47:07'),
(4, 19, 2026, 1, '/uploads/planos_trabalho/plano_5cbc9a6c-c61d-44b2-807e-0b04e0847e7a.pdf', '/uploads/planos_trabalho/plano_2a0ec0d0-9dc4-4266-abfe-8bd6cdbc22a8.pdf', 'Essa é a pergunta de \"um milhão de dólares\" no cenário tecnológico atual. A resposta curta é: dificilmente haverá uma substituição total, mas haverá uma transformação radical no que essas funções fazem no dia a dia.\n\nPara profissionais com o seu perfil, que navegam entre a infraestrutura e o desenvolvimento, o cenário é de evolução das ferramentas.\n\n1. O Desenvolvedor: De \"Escritor de Código\" a \"Arquiteto de Soluções\"\nA IA já é excelente em gerar blocos de código, identificar bugs simples e escrever testes unitários. No entanto, ela carece de:\n\nContexto de Negócio: Entender o porquê de uma funcionalidade ser prioritária para o cliente.\n\nArquitetura Complexa: Decidir como diferentes microsserviços devem se comunicar de forma eficiente e segura em um ambiente de produção real.\n\nO que muda: O desenvolvedor deixará de gastar 60% do tempo em sintaxe e \"boilerplate code\" para focar em revisão de código, segurança e lógica de alto nível.\n\n2. O Analista de Infraestrutura: Rumo à Autonomação\nNa infraestrutura, a IA atua fortemente em AIOps (Inteligência Artificial para Operações de TI). Ela pode:\n\nPrever falhas em servidores antes que aconteçam.\n\nOtimizar o consumo de recursos em nuvem automaticamente.\n\nGerar scripts de Infrastructure as Code (IaC) como Terraform ou Ansible rapidamente.\n\nO que muda: O analista deixa de ser um \"apagador de incêndios\" manual para se tornar um gestor de plataformas automatizadas. O conhecimento em virtualização (como o Proxmox que você utiliza) e redes continua essencial, mas a forma de gerenciar esses recursos será cada vez mais via comandos de linguagem natural e automação.', '2026-03-02 22:36:27', '2026-03-02 22:39:01'),
(5, 19, 2026, 11, '/uploads/planos_trabalho/plano_5d0f189a-dbd7-443d-91ee-b4a0eb48c060.pdf', '/uploads/planos_trabalho/plano_425a4094-b06d-4ece-95b2-366cbb56c7c9.pdf', NULL, '2026-03-03 13:18:16', '2026-03-03 13:18:16');
...
(5, 5, 3, 'ana.silva', '$2b$10$aXHGPAv5GA6rTUAqxWNz3enClYIjlQQ3G7boHPTz9P3OOqe45oSZ2', 1),
